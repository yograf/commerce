...
$options['db_passwd'] = '4mFppWVfzi';
$options['db_name'] = 'devcommercedevsh';
$options['db_user'] = 'devcommercedevsh';
...
@include_once('/var/aegir/projects/commerce/dev/sites/dev.commerce.devshop.syneronapi.us/local.drushrc.php');
